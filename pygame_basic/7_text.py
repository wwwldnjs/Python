...
enemy_x_pos = screen_width / 2 - enemy_width / 2              #화면 가로 크기의 절반에 해당하는 곳에 위치(중앙)
enemy_y_pos = screen_height/2 - enemy_height / 2                #화면 세로 크기의 가장 아래 해당하는 곳에 위치(가장아래)
...
while running:
    ...
    timer = game_font.render(str(int(total_time - elapsed_time)), True, (255, 255, 255))     #render : 표시 (총시간에서 경과시간 빼기)
    #출력할 글자, True, 글자색상
...
#종료하기 전 잠시 대기
pygame.time.delay(2000) #2초 정도 잠시 대기
#pygame.종료
pygame.quit()